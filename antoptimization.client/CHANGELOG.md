...
- Create Angular project with ng: `ng new antoptimization.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`antoptimization.client.esproj`).

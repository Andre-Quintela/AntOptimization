...
public class CompareRouteServiceTests
{
    ...
    private static (
        ...
        Mock<ITwoOptService>,
        Mock<IGeneticAlgorithmService>) CreateMocks(double distance = 5000.0)
    {
        ...
        return (mockDms, mockAco, mockNn, mockTwoOpt, mockGa);
    }
    ...
    private static CompareRouteService CreateService(
        ...
        => new(dms.Object, aco.Object, nn.Object, twoOpt.Object, ga.Object);

    [Fact]
    public async Task CompareRoutesAsync_ReturnsResultForEachAlgorithm()
    {
        var (dms, aco, nn, twoOpt, ga) = CreateMocks();
